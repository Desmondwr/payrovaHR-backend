    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institution', models.ForeignKey(blank=True, help_text='Institution owning this configuration (nullable for single-tenant setups).', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='treasury_configurations', to='accounts.employerprofile')),
            ],
            options={
