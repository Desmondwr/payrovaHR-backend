    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('branch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='attendance_kiosk_stations', to='employees.branch')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('branch', models.ForeignKey(blank=True, help_text='Branch this site belongs to (optional for global sites).', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='attendance_sites', to='employees.branch')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('branch', models.ForeignKey(blank=True, help_text='Branch this Wi-Fi is restricted to (optional for global).', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='attendance_wifi_networks', to='employees.branch')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kiosk_station', models.ForeignKey(blank=True, help_text='Branch kiosk station used for this record.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='attendance_records', to='attendance.attendancekioskstation')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['employer_id', 'branch', 'is_active'], name='attendance__employe_b02fc2_idx'),
        ),
        migrations.AddIndex(
            model_name='attendancelocationsite',
            index=models.Index(fields=['employer_id', 'is_active'], name='attendance__employe_82d2fc_idx'),
        ),
        migrations.AddIndex(
            model_name='attendancelocationsite',
            index=models.Index(fields=['latitude', 'longitude'], name='attendance__latitud_772766_idx'),
        ),
        migrations.AddIndex(
            model_name='attendancelocationsite',
            index=models.Index(fields=['employer_id', 'branch'], name='attendance__employe_0eb7ed_idx'),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['employer_id', 'ssid'], name='attendance__employe_12728b_idx'),
        ),
        migrations.AddIndex(
            model_name='attendanceallowedwifi',
            index=models.Index(fields=['employer_id', 'bssid'], name='attendance__employe_476164_idx'),
        ),
        migrations.AddIndex(
            model_name='attendanceallowedwifi',
            index=models.Index(fields=['employer_id', 'branch'], name='attendance__employe_33ab35_idx'),
        ),
        migrations.AddConstraint(
            model_name='attendanceallowedwifi',
            constraint=models.UniqueConstraint(fields=('employer_id', 'branch', 'ssid', 'bssid'), name='uniq_attendance_wifi_entry'),
        ),
        migrations.AddIndex(
            model_name='attendancerecord',
            index=models.Index(fields=['employer_id', 'employee'], name='attendance__employe_f2192c_idx'),
        ),
        migrations.AddIndex(
            model_name='attendancerecord',
        ...
        migrations.AddIndex(
            model_name='attendancerecord',
            index=models.Index(fields=['mode'], name='attendance__mode_02d5d5_idx'),
        ),
        migrations.AddIndex(
            model_name='attendancerecord',
            index=models.Index(fields=['check_in_at'], name='attendance__check_i_dc8e86_idx'),
        ),
        migrations.AddConstraint(
            model_name='attendancerecord',
            constraint=models.UniqueConstraint(condition=models.Q(('check_out_at__isnull', True)), fields=('employee',), name='uniq_open_attendance_record_per_employee'),
        ),
        migrations.AddConstraint(
            model_name='attendancerecord',
            constraint=models.CheckConstraint(condition=models.Q(('check_out_at__gt', models.F('check_in_at')), ('check_out_at__isnull', True), _connector='OR'), name='attendance_checkout_after_checkin'),
        ),
        migrations.AddConstraint(
            model_name='workingscheduleday',
            constraint=models.CheckConstraint(condition=models.Q(('end_time__gt', models.F('start_time'))), name='working_schedule_day_end_after_start'),
        ),
        migrations.AlterUniqueTogether(
            name='workingscheduleday',
