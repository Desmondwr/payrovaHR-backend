...
class TenantDatabaseRouter:
    ...
    def allow_relation(self, obj1, obj2, **hints):
        ...
        if app1 == app2 and app1 in ['employees', 'contracts', 'payroll', 'frontdesk', 'timeoff', 'attendance', 'treasury', 'income_expense', 'recruitment', 'communications', 'billing']:
            return True
        
        # Allow relations between tenant apps (e.g., Contract -> Employee)
        if app1 in ['employees', 'contracts', 'frontdesk', 'timeoff', 'attendance', 'treasury', 'income_expense', 'recruitment', 'billing'] and app2 in ['employees', 'contracts', 'frontdesk', 'timeoff', 'attendance', 'treasury', 'income_expense', 'recruitment', 'billing']:
            return True
